            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('partnership') }}" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('earnings') }}" aria-expanded="false">
                                <span>
        ...
        <div class="body-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <a href="{{ route('profile.show') }}" class="">{{Auth::user()->name}}</a>
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    @else
                                    <img src="/assets/images/profile/user-1.png" alt="{{ Auth::user()->name }}" class="rounded-circle">
                                    @endif
                                </a>
                      ...
                      <p class="mb-0 fs-3">Mon Compte</p>
                                        ...
                                        <form action="{{ route('logout') }}" class="form" method="post">
                                            ...
                                            <button type="submit" class="btn btn-outline-primary mx-3 mt-2 d-block" onclick="return confirm('Déconnexion en cours, OK ?') ">Se Déconnecter</button>
                                        </form>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form class="row g-3 offset-md-2 mb-5" action="{{ route('search.results') }}" method="get">
                        @csrf
                        <div class="col">
